...
<?php
    ...
    //echo  $DateTime;
     ...
     //------------------------------------------//
     if(empty($ins_Pass)) {
      $_SESSION["ErrorMessage"] = "Please input right password to Countinue";
      Redirect_to("password.php");

     }else {
      //----Query to insert Comments Into the DB --------
      global $ConnectingDB;
   $sql  = "INSERT INTO password(password, datetime)";
   $sql .= "VALUES(:UserPassword, :DateTime)";
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <?php
                    ...
                    echo SuccessMessage();
                ?>
            <form class="form-class" action="password.php" method="post">
              <div class="col-auto">
